                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">
                            <div class="page-header-icon"><i data-feather="coffe"></i></div>
                            Tables Data Cafe
                        </h1>
                    </div>
                </div>
    ...
    <div class="container-xl px-4 mt-n10">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <table id="datatablesCafe" class="table">
                    <thead>
                        <tr>
                            <th>Username</th>
                            <th>Name</th>
                        ...
                        @foreach ($DataCafe as $x)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn-datatable btn-icon btn-transparent-dark" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal{{ $x->id }}" data-target="#exampleModal"
                                        data-admin-id="{{ $x->id }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">DETAIL DATA CAFE</h5>
